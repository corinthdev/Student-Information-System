...
{
    public abstract class SISWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SISWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SISWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SISDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SISDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SISDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SISDbContext, Task<T>> func)
        {
            T result;
